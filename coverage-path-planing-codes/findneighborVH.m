function next = findneighborVH(pwavefront,status,current)
    coordinate = [];
    ...
    i = 1;
     ...
     end %do the judgement for the top point of current point
     ...
     end % do the judgement for the bottom point
     if current(2) > 1
